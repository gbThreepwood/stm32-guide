 ...
 * @brief Basic DAC usage demo
 * @version 0.1
 * @date 2023-01-30
 * 
 * @copyright Copyright (c) 2023
 * 
 * Generate a sine wave output on the DAC of the Nucleo-L476RG
 * 
 */
...
void write_dac_float(float value_volt){

    uint16_t value_raw = (value_volt * 4096) / VOLTAGE_REFERENCE;
